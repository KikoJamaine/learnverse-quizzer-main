...
const features = [
  ...
  },
  {
    ...
    description: 'Professor can view scores, track achievements, and receive study recommendations.',
    icon: GraduationCap,
  },
  {
    name: 'Multi-Format Questions',
    description: 'Support for multiple-choice, true/false, and essay-answer questions.',
    icon: BookOpen,
  },
];
